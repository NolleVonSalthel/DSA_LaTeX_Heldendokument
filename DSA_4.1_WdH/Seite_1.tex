...
&\textbf{Rasse} & \multicolumn{3}{l}{ \CharakterRasse} &   \\\cline{2-5}
&\textbf{Kultur} & \multicolumn{3}{l}{\CharakterKultur} & \\\cline{2-5}
&\textbf{Profession} & \multicolumn{3}{l}{\CharakterProfession} & \\\specialrule{3pt}{0pt}{0pt}
\end{tabular}
\\[5mm]
%
% 2. Reihe
...
\specialrule{3pt}{0pt}{0pt}
\end{tabular}
\begin{tabular}{!{\VRule[3pt]}lp{21mm}p{32.6mm}l!{\VRule[3pt]}}
\specialrule{3pt}{0pt}{0pt}
...
\textbf{INI-Basiswert} & \BasisINImod & \BasisINIstart & \BasisINIaktuell & \multicolumn{2}{p{25mm}!{\VRule[3pt]}}{\vspace{-15pt}\tiny \SFKreuzchen{Kampfgespür}Kampfgespür(+2) \SFKreuzchen{Kampfreflexe}Kampfreflexe(+4)\vspace{-2pt}}\\\hline
\textbf{AT-Basiswert} & \BasisATmod & \BasisATstart & \BasisATaktuell &  \multicolumn{2}{p{25mm}!{\VRule[3pt]}}{\multirow{3}{25mm}{{ \textbf{Wundschwelle}} {\tiny (KO/2)$\pm$ Mod}  \BasisWundschwelle}}\\\cline{1-4}
