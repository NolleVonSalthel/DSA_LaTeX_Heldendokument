...
\include{Commandset} % Commandset laden
%----------------------------------------------------------------------------------------
%	BEGINN DES DOKUMENTS
%----------------------------------------------------------------------------------------
\include{CharakterKonfiguration} % Charakter Konfiguration laden

\begin{document}
\include{AutoMakros} % Automatische Makros laden
\include{Seite_1} % erste Seite (Übersicht, Eigenschaften & Basiswerte)
\newpage
\include{Seite_2} % zweite Seite (Talente)
\newpage
\include{Seite_3} % dritte Seite (Waffen & Kampfwerte)
\newpage
\include{Seite_4} % vierte Seite (Ausrüstung, Vermögen & Verbindungen)
\ifnum\value{ZauberAnzahl}>0
	\newpage
	\include{Seite_5} % fünfte Seite (Zauberdokument 1)
\fi
\ifnum\value{ZauberAnzahl}>33
	\newpage
	\include{Seite_6} % sechste Seite (Zauberdokument 2)
\fi
\end{document}
